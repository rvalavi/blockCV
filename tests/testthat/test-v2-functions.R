...
test_that("test spatialAutoRange function works", {
    ...
    expect_equal(print(range1), "SpatialAutoRange")
    expect_silent(plot(range1))
    expect_output(summary(range1))
...
test_that("test spatialAutoRange function with x", {
    ...
    expect_equal(print(range3), "SpatialAutoRange")
    expect_silent(plot(range3))
...
test_that("test spatiaBlock function works", {
    ...
    expect_output(print(sb1))
    expect_output(summary(sb1))
    expect_message(plot(sb1))
...
test_that("test buffering function works", {
    ...
    expect_output(print(bf1))
    expect_output(summary(bf1))

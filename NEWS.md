...
- `cv_spatial` now reuses a single block-to-point intersection when subsetting non-empty blocks and assigning records to blocks, avoiding duplicate spatial intersection work; issue [#40](https://github.com/rvalavi/blockCV/issues/40).
